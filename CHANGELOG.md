...
- **Módulo 5 pendiente:** `5.2.6` listado y búsqueda de usuarios, `5.2.7` habilitación/deshabilitación con confirmación y `5.2.8` completar la protección y navegación administrativa. La cuenta administrativa simulada funciona solo en desarrollo.
